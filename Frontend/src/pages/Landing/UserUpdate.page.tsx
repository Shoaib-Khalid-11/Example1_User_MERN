...
export const UpdateUser_Page = () => {
  ...
  //           <div className="text-center">
  //             <FiAlertCircle className="text-6xl text-error mx-auto mb-4" />
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {getisSuccessUserByIDUpdate && (
          <div className="alert alert-success mb-6 animate-fadeInUp">
            <AppIcon_Element icon="prime:check-circle" className="text-lg" />
            <span>{getisSuccessUserByIDUpdate}</span>
            <button
              ...
              <div className="bg-base-100/80 backdrop-blur-xl rounded-2xl p-6 border border-base-300/50 shadow-xl col-span-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="form-control">
                    ...
                    <div
                    //   className={`badge ${formData.isVerified ? "badge-success" : "badge-warning"} badge-lg w-full py-3 justify-center`}
                    >
                      {/* {formData.isVerified ? "Active" : "Pending Verification"} */}
                    </div>
                  </div>
                </div>
              </div>
...
export default UpdateUser_Page;
{
  /* <div className="bg-base-100/80 backdrop-blur-xl rounded-2xl p-6 border border-base-300/50 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium">Refresh Token</span>
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="input input-bordered w-full pl-10 bg-base-200/50 focus:ring-2 focus:ring-primary/50 transition-all font-mono text-sm"
              ...
              <div className="form-control">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    // value={formData.verificationTokenExpire}
                    // onChange={handleChange}
                    className="input input-bordered w-full pl-10 bg-base-200/50 focus:ring-2 focus:ring-primary/50 transition-all"
                  />
                </div>
